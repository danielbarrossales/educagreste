...
@SpringBootTest
public class TestCadastroController {
    @Autowired
    private CadastroUsuarioController cadastroUsuarioController;

    @Test
    void componentesInjetadosNaoSaoNulos() {
        Assert.notNull(cadastroUsuarioController, "A classe '" + cadastroUsuarioController.getClass().getName() + "' não foi injetada pelo sprint");
    }
